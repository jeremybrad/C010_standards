...
| File | Path | SHA256 |
|------|------|--------|
| CSV | `10_docs/notes/workspace_triage/workspace_triage_20251230.csv` | `d1336f866cd39a4c...` |
| Receipt | `C010_standards/20_receipts/workspace_triage/workspace_triage_20251230.md` | (this file) |
...
- **Import risk hits:** 2
- **Examples:** `external/standards/validators/run_all.py:17:    sys.path.insert(0, str(REPO_ROOT)) | external/standa`

### C002_sadb
- **Reason:** Python repo with 10 sibling-dir import patterns
...
- **Import risk hits:** 10
- **Examples:** `pipeline/scripts/claude_extractor_v2.py:10:sys.path.insert(0, os.path.dirname(os.path.dirname(os....`
...
- **Import risk hits:** 10
- **Examples:** `tests/test_policy_enforcement.py:27:sys.path.insert(0, str(Path(__file__).parent.parent / "40_src"))`
...
- **Reason:** Python repo with 6 sibling-dir import patterns
...
- **Import risk hits:** 6
- **Examples:** `custom/betty_voice_integration.py:15:    sys.path.insert(0, betty_path) | tests/test_roundtable.py:1`
...
- **Import risk hits:** 10
- **Examples:** `90_tests/test_expansion.py:16:sys.path.insert(0, str(Path(__file__).parent.parent / "40_src")) | 90_`

### C010_standards
- **Reason:** Python repo with 10 sibling-dir import patterns
- **Invalid dirs:** prompts;protocols;registry;schemas;scripts;taxonomies;tests;tools;validators;workspace
- **Import risk hits:** 10
- **Examples:** `scripts/workspace_triage.py:37:    r"from scripts\b", | scripts/workspace_triage.py:38:    r"import `
...
- **Import risk hits:** 10
- **Examples:** `p181/rehydrator_adapter.py:20:        sys.path.insert(0, sp) | test_turbo.py:11:sys.path.insert(0, s`

### C019_docs-site
- **Reason:** Python repo with 10 sibling-dir import patterns
- **Invalid dirs:** _audits;data;docs;evals;lora_adapters;rag;scripts;site;ui
- **Import risk hits:** 10
- **Examples:** `test_rag.py:5:sys.path.insert(0, str(Path(__file__).parent)) | debug_embeddings.py:5:sys.path.insert`

### C020_pavlok
- **Reason:** Python repo with 1 sibling-dir import patterns
- **Invalid dirs:** docs;scripts
- **Import risk hits:** 1
- **Examples:** `40_src/tests/conftest.py:10:sys.path.insert(0, str(Path(__file__).parent.parent))`

### P030_ai-services
- **Reason:** Python repo with 4 sibling-dir import patterns
- **Invalid dirs:** __pycache__;betty-venv;cognitive-venv
- **Import risk hits:** 4
- **Examples:** `memory-api-server.py:8:sys.path.append(os.path.expanduser('~/SyncedProjects/Workspace')) | memory-ap`
...
- **Import risk hits:** 5
- **Examples:** `examples/orpheus_mcp_demo.py:24:sys.path.insert(0, str(Path(__file__).parent.parent / "src")) | exam`

### P052_n8n-mcp-setup
- **Reason:** Python repo with 1 sibling-dir import patterns
- **Invalid dirs:** caddy;n8n-data;n8n-mcp-setup;redis-data;workflows
- **Import risk hits:** 1
- **Examples:** `dewey-dual-scanner.py:221:    sys.path.append(os.path.dirname(os.path.abspath(__file__)))`
...
- **Import risk hits:** 10
- **Examples:** `debug_relay.py:14:sys.path.append('/Users/jeremybradford/SyncedProjects/relay/scripts') | roundtable`

### P092_mirrorlab
- **Reason:** Python repo with 10 sibling-dir import patterns
- **Invalid dirs:** forensics;research
- **Import risk hits:** 10
- **Examples:** `40_src/test_gpt41_force.py:11:sys.path.insert(0, str(Path(__file__).parent)) | 40_src/test_few_conve`
...
- **Import risk hits:** 10
- **Examples:** `kst_modules/dynamic_context.py:159:        relevant = ["PATH", "PYTHONPATH", "VIRTUAL_ENV", "COND...`
...
- **Import risk hits:** 10
- **Examples:** `verify_phase8.py:108:        env["PYTHONPATH"] = "." | verify_phase8.py:255:        env["PYTHONPATH"`
...
- **Import risk hits:** 2
- **Examples:** `custom/betty_voice_integration.py:15:    sys.path.insert(0, betty_path) | betty_voice_server.py:25: `
...
- **Import risk hits:** 4
- **Examples:** `m1_emotional/scripts/process_batch.py:24:sys.path.insert(0, str(Path(__file__).parent)) | scripts/d0`
...
- **Import risk hits:** 6
- **Examples:** `nodes.py:22:sys.path.insert(0, os.path.join(os.path.dirname(os.path.realpath(__file__)), "comfy")) |`


---
*Generated by workspace_triage.py at 20251230_192058*
